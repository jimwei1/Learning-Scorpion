...
def Generate_Brain():
    ...
    pyrosim.Send_Sensor_Neuron(name = 0, linkName = b'Torso')
    pyrosim.Send_Sensor_Neuron(name = 1, linkName = b'BackLeg')
    pyrosim.Send_Sensor_Neuron(name = 2, linkName = b'FrontLeg')
